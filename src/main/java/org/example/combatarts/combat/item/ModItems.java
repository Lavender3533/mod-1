package org.example.combatarts.combat.item;
...
public class ModItems {
    ...
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, CombatArts.MODID);

    private static ResourceKey<Item> key(String name) {
        return ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(CombatArts.MODID, name));
    }
    ...
    public static final List<RegistryObject<Item>> ALL_SWORDS = List.of(
    ...
    public static final List<RegistryObject<Item>> ALL_SPEARS = List.of(
